<div class="container mx-auto grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 text-gray-900 px-3">
    ...
    <form method="post" action="" onsubmit="return validateSignup()">
        ...
        <div class="grid lg:grid-cols-2 lg:gap-3">
            <div class="mb-6 input-controller">
        ...
        <div class="mb-6 input-controller">
            ...
            <input type="password" id="ver_password" name="password_confirm" class="bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="your password" required>
            <div class="error"></div>
